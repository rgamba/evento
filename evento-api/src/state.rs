use crate::{OperationInput, OperationResult, WorkflowError};
use anyhow::Result;
...
pub trait Store {
    fn get_operation_results(&self, workflow_id: &Uuid) -> Result<Vec<OperationResult>>;
    ...
    fn mark_completed(&self, workflow_id: &Uuid) -> Result<()>;
